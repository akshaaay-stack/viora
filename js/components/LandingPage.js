    ...
    <div class="space-y-16 pb-20">
      ...
      <section class="relative overflow-hidden bg-gradient-to-b from-rose-50/60 via-white to-white py-16 sm:py-24 border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-800 tracking-tight font-display max-w-4xl mx-auto mb-6">
            "${VIORA_CONFIG.TAGLINE}"
          </p>

          <!-- Supporting Message -->
          <p class="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
            ${VIORA_CONFIG.SUBTITLE}
          </p>

          <!-- Primary & Secondary CTAs -->
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
            <button onclick="window.vioraApp.navigateTo('request')" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-rose-700 hover:bg-rose-800 text-white font-bold text-base shadow-lg shadow-rose-900/20 hover:shadow-rose-900/30 flex items-center justify-center gap-2 transition">
              <i data-lucide="search" class="w-5 h-5"></i>
              <span>Find a Donor</span>
            </button>
            <button onclick="window.vioraApp.navigateTo('donor')" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-bold text-base border-2 border-slate-200 hover:border-slate-300 shadow-sm flex items-center justify-center gap-2 transition">
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <!-- Section: 90-Day Donation Interval -->
          <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-3 hover:shadow-md transition">
        ...
        <div class="bg-rose-900 rounded-3xl p-8 sm:p-12 text-center text-white relative overflow-hidden shadow-xl">
          <div class="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <button onclick="window.vioraApp.navigateTo('request')" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white text-rose-900 font-bold text-sm shadow-md hover:bg-rose-50 transition">
                Create Emergency Request
              </button>
              <button onclick="window.vioraApp.navigateTo('donor')" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-rose-800 hover:bg-rose-700 text-white font-bold text-sm border border-rose-600 transition">
                Open Donor Hub
              </button>
            </div>
          </div>
