...
export function renderModalOverlay() {
  ...
  switch (modal.type) {
    case 'contactReveal':
      return renderContactRevealModal(modal.data);
    case 'donorRegister':
      return renderDonorRegisterModal();
    case 'notifications':
      ...
      <div class="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-slate-200 space-y-6">
        ...
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-3">
            <div class="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-800 flex items-center justify-center shadow-inner">
