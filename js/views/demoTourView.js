/**
 * VIORA Hackathon Demo Tour View Overlay
 */

export function renderDemoTourOverlay() {
  ...
  return `
    <div class="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-6 sm:max-w-md z-50 bg-slate-900/95 backdrop-blur-md text-white p-5 rounded-2xl shadow-2xl border-2 border-amber-500/80 animate-fade-in">
      ...
      <div class="flex items-center gap-2">
        <button onclick="window.vioraApp.runDemoStepAction()" class="w-full py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-extrabold text-xs shadow-md transition flex items-center justify-center gap-1.5 btn-touch">
